...
//shell_exec('sudo vkbotreport '.urlencode($rec));
if (empty($data['message']['chat']['id'])) {
        exit();
}
define('TOKEN', '1310579045:AAGsOYM48mezal1-HQl1E9B9H98M2v-j8fI');
...
if (!empty($data['message']['text'])) {
        ...
        if ($text == '/start') {
                sendTelegram(
                        ...
                        array(
                                'chat_id' => $data['message']['chat']['id'],
                                'text' => 'Привет! Отправь мне CP1251-закодированный .txt файл электронной книги, а я посчитаю упоминания цветов в ней. Книги такого формата можно найти, например, на https://litres.ru'
                        )
                );
                exit();
        }
